...
// Helper to convert array to Set for answeredQuestions
const answeredQuestionsToSet = (arr: string[]): Set<string> => new Set(arr);
  ...
  persist(
    (set, get) => ({
      ...
      markCorrect: () => {
        ...
        const newAnswered = [...answeredQuestions, questionKey];
      ...
      addPlayer: (name) => {
        ...
        const newPlayer: Player = {
          ...
          emoji: TEAM_EMOJIS[playerIndex + 2],
        };
...
// Export helper for components that need Set behavior
export const getAnsweredQuestionsSet = (answeredQuestions: string[]): Set<string> =>
  answeredQuestionsToSet(answeredQuestions);
